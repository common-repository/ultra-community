...
jQuery(document).ready(function(){
    jQuery('body').prepend('<div class="howl-iconpicker-outer"><div class="howl-iconpicker-middle"><div class="howl-iconpicker"><input type="text" class="srchicons uc-clear" placeholder="search icon"><div class="iconsholder"></div></div><div class="howl-iconpicker-close">Close</div></div></div>'); // Appending Iconpicker box below input box
    ...
    //jQuery(".howl-iconpicker .iconsholder").append(' <p class="iconsholder"><input type="text" class="srchicons uc-clear" placeholder="search icon"></p>');
...
(function(jQuery) {
    ...
    jQuery.fn.iconpicker = function(selector) {
        ...
        jQuery(this).focusin(function() {
            ...
            var whichInputClass = jQuery(this).attr('class');
