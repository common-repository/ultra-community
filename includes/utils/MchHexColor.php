...
//		}
	...
	public function isLight($lighterThan = 130 ){
		return !$this->isDark($lighterThan);
	...
	public function isDark( $darkerThan = 130 ){
		...
		//echo "Darkness => " . (( $r*299 + $g*587 + $b*114 ) /1000)  . "\n";exit;
		
		return (( $r*299 + $g*587 + $b*114 )/1000 <= $darkerThan);
		
//		$arrColors = array_map(function($color){
//			$color = $color / 255;
//			return ($color <= 0.03928) ? $color / 12.92 : pow(($color + 0.055) / 1.055, 2.4);
//		}, self::hexToRgb($color));
//
//		return  0.2126 * $arrColors['R'] + 0.7152 * $arrColors['G'] + 0.0722 * $arrColors['B'] <= 0.179;
	}
